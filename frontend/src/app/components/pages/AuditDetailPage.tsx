...
/* ============================================================
   ...
   BLUE HEADER IS APPLIED ONLY WHEN blueHeader = true
============================================================ */
...
export function AuditDetailPage({
  ...
  return (
    ...
    >
      ...
      <div
        className="p-6 max-w-6xl mx-auto flex flex-col gap-5"
      >
          ...
          >
            ...
            >
              ...
              {log.errorCode && (
                ...
                <div
                  className="mt-3 flex items-center justify-between p-3 rounded"
                  style={{
                    background:
                      "#fff2f2",
            ...
            {/* ==================================================
                OPERATOR
                LEFT SIDE BELOW ACTION DETAILS
            =================================================== */}
