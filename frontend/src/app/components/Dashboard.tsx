...
export function Dashboard({
  ...
  /* =======================================================
     ...
     IMPORTANT:
     showFilters = false
     means filter is CLOSED when page loads.
  ======================================================= */
  ...
  const actions = [
    {
      id: "single-user" as DashNav,
      label: "Single User Creation",
      desc: "Provision one user with roles & validity",
      icon: UserPlus,
      color: F.primary,
      bg: "#e8f2ff",
    },
    ...
    {
      id: "bulk-user" as DashNav,
      label: "Bulk User Creation",
      desc: "Import users from an Excel sheet",
      icon: Upload,
      color: F.purple,
      bg: "#f3e5f5",
    },
    ...
    {
      id: "password-reset" as DashNav,
      label: "Password Reset",
      desc: "Generate a temporary password",
      icon: KeyRound,
      color: F.warning,
      bg: "#fff8f0",
    },
    ...
    {
      id: "lock-unlock" as DashNav,
      label: "Lock / Unlock User",
      desc: "Lock users or unlock wrong-password lockouts",
      icon: Lock,
      color: F.error,
      bg: "#fff2f2",
    },
    ...
    {
      id: "audit-logs" as DashNav,
      label: "Audit Logs",
      desc: "Search, filter & export activity",
      icon: ClipboardList,
      color: F.muted,
      bg: "#f5f6f7",
    },
  ...
  const moduleCounts = useMemo(() => {
    ...
    return (
      Object.keys(MODULE_META) as AuditModule[]
    )
      .map((mod) => ({
        mod,
        count: m[mod] ?? 0,
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right flex-shrink-0">
                          ...
                          <span
                            className="flex items-center gap-1 px-2 py-0.5 rounded text-xs justify-center"
                            style={{
                              background:
                                sta.bg,
                              color:
